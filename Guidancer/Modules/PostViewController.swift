...
protocol PostRouterDelegate: AnyObject {
    func didSelect(_ viewController: PostViewController)
}

final class PostViewController: UIViewController, ViewControllerProtocol {
    var routerDelegate: PostRouterDelegate?
    ...
    private lazy var postButton = GButton() {_ in
        print("ggg")
    ...
    func configAddLocation() {
        ...
        addLocation.setTitleColor(.gBlack, for: .normal)
        addLocation.layer.borderColor = UIColor.gBlack?.cgColor
    ...
    func configPost() {
        ...
        postButton.backgroundColor = .gBlack
